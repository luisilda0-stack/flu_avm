...
class PokeApiPokemonResponsio {
    ...
    factory PokeApiPokemonResponsio.fromJson(Map<String, dynamic> json) => PokeApiPokemonResponsio(
        ...
        pastStats: List<PastStat>.from(json["past_stats"].map((x) => PastStat.fromJson(x))),
...
class GenerationViii {
    final DreamWorld brilliantDiamondShiningPearl;
    final DreamWorld icons;
    ...
    factory GenerationViii.fromJson(Map<String, dynamic> json) => GenerationViii(
        brilliantDiamondShiningPearl: DreamWorld.fromJson(json["brilliant-diamond-shining-pearl"]),
        icons: DreamWorld.fromJson(json["icons"]),
    );
